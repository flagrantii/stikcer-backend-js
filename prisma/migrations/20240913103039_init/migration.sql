/*
  ...
  - You are about to drop the column `deleteAt` on the `File` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `createAt` on the `OrderLine` table. All the data in the column will be lost.
  - You are about to drop the column `updateAt` on the `OrderLine` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `updateAt` on the `ProductCategory` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "OrderLine" DROP COLUMN "createAt",
DROP COLUMN "updateAt",
ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
ADD COLUMN     "updatedAt" TIMESTAMP(3) NOT NULL;
