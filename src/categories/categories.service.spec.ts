...
describe('CategoriesService', () => {
  ...
  describe('createCategory', () => {
    ...
    it('should throw ForbiddenException if user is not admin', async () => {
      ...
      await expect(
        service.createCategory(createCategoryDto, user),
  ...
  describe('findAllCategories', () => {
    it('should return all categories', async () => {
      ...
      mockDatabaseService.productCategory.findMany.mockResolvedValue(
        categories,
      );
  ...
  describe('findCategoryById', () => {
    it('should return a category by ID', async () => {
      ...
      mockDatabaseService.productCategory.findUnique.mockResolvedValue(
        category,
      );
      ...
      expect(result).toEqual(category);
      expect(
        mockDatabaseService.productCategory.findUnique,
  ...
  describe('updateCategoryById', () => {
    it('should update a category', async () => {
      ...
      const user: User = { id: '1', role: 'ADMIN' } as User;
      const existingCategory: ProductCategory = {
        id: '1',
        name: 'Category 1',
        createdAt: new Date(),
        updatedAt: new Date(),
      ...
      mockDatabaseService.productCategory.update.mockResolvedValue(
        updatedCategory,
      );
    ...
    it('should throw NotFoundException if category not found', async () => {
      ...
      await expect(
        service.updateCategoryById('1', updateCategoryDto, user),
  ...
  describe('deleteCategoryById', () => {
    ...
    it('should throw NotFoundException if category not found', async () => {
      ...
      await expect(service.deleteCategoryById('1', user)).rejects.toThrow(
        NotFoundException,
      );
    });
