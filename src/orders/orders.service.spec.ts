...
describe('OrdersService', () => {
  ...
  describe('createOrder', () => {
    it('should create an order', async () => {
      ...
      const order = { id: '1', ...createOrderDto, userId: user.id, orderSubTotal: 200 };
    ...
    it('should throw InternalServerErrorException if creation fails', async () => {
      ...
      await expect(service.createOrder(createOrderDto, user)).rejects.toThrow(InternalServerErrorException);
    });
  });
  ...
  describe('findAllOrders', () => {
    ...
    it('should throw ForbiddenException if non-admin user tries to access all orders', async () => {
      ...
      await expect(service.findAllOrders(user)).rejects.toThrow(ForbiddenException);
    });
  });
  ...
  describe('findOrdersByUserId', () => {
    it('should return orders for a specific user', async () => {
      ...
      expect(result).toEqual(orders);
      expect(mockDatabaseService.order.findMany).toHaveBeenCalledWith({ where: { userId: '1' }, include: { orderLines: true } });
    });

    it('should throw ForbiddenException if user is not authorized', async () => {
      const user: User = { id: '2', role: 'USER' } as User;

      await expect(service.findOrdersByUserId('1', user)).rejects.toThrow(ForbiddenException);
    });
  });
  ...
  describe('findOrderById', () => {
    it('should return an order by ID', async () => {
      ...
      expect(result).toEqual(order);
      expect(mockDatabaseService.order.findUnique).toHaveBeenCalledWith({ where: { id: '1' }, include: { orderLines: true } });
    });
    ...
    it('should throw NotFoundException if order not found', async () => {
      ...
      await expect(service.findOrderById('1', user)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ForbiddenException if user is not authorized', async () => {
      ...
      await expect(service.findOrderById('1', user)).rejects.toThrow(ForbiddenException);
    });
  });
  ...
  describe('updateOrderById', () => {
    ...
    it('should throw NotFoundException if order not found', async () => {
      ...
      await expect(service.updateOrderById('1', updateOrderDto, user)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ForbiddenException if user is not authorized', async () => {
      ...
      await expect(service.updateOrderById('1', updateOrderDto, user)).rejects.toThrow(ForbiddenException);
    });
  });
  ...
  describe('deleteOrderById', () => {
    ...
    it('should throw NotFoundException if order not found', async () => {
      ...
      await expect(service.deleteOrderById('1', user)).rejects.toThrow(NotFoundException);
    });
    ...
    it('should throw ForbiddenException if user is not authorized', async () => {
      ...
      await expect(service.deleteOrderById('1', user)).rejects.toThrow(ForbiddenException);
    });
  });
});
